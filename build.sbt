...
lazy val adlsFileSystem = (project in file("filesystems/adls"))
  .withLibrarySettings("cromwell-adlsFileSystem", adlsFileSystemDependencies)
  .dependsOn(core)
  .dependsOn(cloudSupport)
  .dependsOn(core % "test->test")
  .dependsOn(cloudSupport % "test->test")
...
lazy val engine = project
  ...
  .dependsOn(httpFileSystem % "test->test")
  .dependsOn(ftpFileSystem % "test->test")
  .dependsOn(adlsFileSystem % "test->test")
